...
void svgRectArea(FILE *svg, float x, float y, float w, float h); // linha de comando de área de impacto
void svgAnchor(FILE *svg, float x, float y); // linha de comando de ancora
#endif 